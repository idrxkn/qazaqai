...
const profiles = [
  {
    ...
    experience:
      "Диссертацияның тақырыбы: «Информатика саласы бойынша білімді өңдеу технологиялары»",
    src: kz,
  },
];
const Profiles = () => {
            ...
            <div className="profile-info">
              ...
              <p>
                ...
                <ul>
                  ...
                  <br />
                  <ol>
                    <b>III. Международно научно-практические конференции</b>{" "}
                ...
                <ul>
                  <li>
                    <a
                      href="/Свидетельство.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      📄 Авторлық құқық куәлігі – Informatics_Kaz (13.03.2025)
                    </a>
                  </li>
                  <li>
                    <a
                      href="/Свидетельство-2.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      📄 Авторлық құқық куәлігі – QazaqAI жүйесі (04.04.2025)
                    </a>
                  </li>
                </ul>
              </p>
